...
import { agendaEntries, routineItemCalendarMarkers } from "@/lib/agenda";
...
export default function CalendarPage() {
  ...
  const markers = useMemo(() => routineItemCalendarMarkers(items.data, monthStart, monthEnd), [items.data, monthEnd, monthStart]);
