...
export type PageInfoKey = "dashboard" | "routine" | "goals" | "habits" | "feedback" | "assistant" | "insights" | "calendar" | "settings";
...
export const pageInfo: Record<SupportedLanguage, PageInfoLocale> = {
  "pt-BR": {
    ...
    pages: {
      dashboard: {
        ...
        connections: "Reúne dados da Rotina, Hábitos e Metas; também leva ao Feedback e ao Alfred quando você precisa ajustar o plano.",
      ...
      goals: {
        ...
        connections: "Os hábitos ligados aparecem em Hábitos e Rotina; o progresso alimenta Insights, Feedback e o contexto do Alfred.",
      ...
      habits: {
        ...
        connections: "Cada hábito pode apoiar uma Meta, ocupar horários na Rotina e gerar padrões usados por Insights, Feedback e Alfred.",
        example: "Se “Treinar” falhar sempre às segundas, reduza a duração nesse dia ou mova o bloco para um horário mais viável.",
      },
      feedback: {
        what: "É uma leitura orientada da sua semana, combinando rotina, hábitos e o objetivo que você deseja analisar.",
        why: "Existe para transformar registros em aprendizado prático, destacando forças, pontos de atenção e um próximo ajuste.",
        how: "Descreva a dúvida ou resultado desejado com clareza e gere uma análise depois de registrar alguns dias de atividade.",
        connections: "Usa dados da Rotina e dos Hábitos; as sugestões podem orientar mudanças nas Metas ou uma conversa mais profunda com Alfred.",
        example: "Pergunte “Como manter meus estudos sem abandonar o treino?” para receber uma sugestão baseada na sua semana.",
      },
      assistant: {
      ...
      insights: {
        ...
        connections: "Consolida registros de Hábitos, Metas e Rotina; seus padrões ajudam Feedback e Alfred a oferecer recomendações melhores.",
  ...
  en: {
    ...
    pages: {
      ...
      goals: { what: "Where you define concrete destinations and connect the habits that support each result.", why: "It gives every objective a deadline, context, and observable recurring actions.", how: "Create a goal, choose a realistic date, and attach a small number of relevant habits.", connections: "Linked habits appear in Habits and Routine; progress feeds Insights, Feedback, and Alfred.", example: "For “Finish my portfolio,” attach “Study design for 40 minutes” five days a week." },
      habits: { what: "Tracking for actions you want to repeat until they become a stable part of your routine.", why: "It shows real consistency, including misses and pending days, without turning one bad day into abandonment.", how: "Log completion, observe the weekly rhythm, and adjust duration or frequency when the plan is too heavy.", connections: "Habits can support Goals, occupy Routine slots, and create patterns for Insights, Feedback, and Alfred.", example: "If a workout always fails on Mondays, shorten it or move it to a more realistic time." },
      feedback: { what: "A guided reading of your week using routine, habits, and the objective you want to examine.", why: "It turns records into practical learning: strengths, attention points, and one next adjustment.", how: "Describe your question clearly and generate an analysis after logging a few days.", connections: "It uses Routine and Habit data and can guide changes to Goals or a deeper Alfred conversation.", example: "Ask, “How can I keep studying without dropping exercise?”" },
      ...
      insights: { what: "A summary of consistency and execution patterns over time.", why: "It reveals trends that are invisible when you look at one isolated day.", how: "Review periodically, compare goals, and look for recurring patterns before changing your routine.", connections: "It consolidates Habits, Goals, and Routine records to improve Feedback and Alfred recommendations.", example: "Low consistency may signal excessive frequency, a poor time slot, or a habit that is too broad." },
  ...
  es: {
    ...
    pages: {
      ...
      feedback: { what: "Es una lectura guiada de tu semana basada en rutina, hábitos y el objetivo que deseas analizar.", why: "Convierte registros en aprendizaje práctico: fortalezas, atención y un siguiente ajuste.", how: "Describe tu duda con claridad y genera el análisis después de registrar algunos días.", connections: "Usa datos de Rutina y Hábitos y puede orientar cambios en Metas o una conversación con Alfred.", example: "Pregunta: “¿Cómo mantengo el estudio sin abandonar el entrenamiento?”" },
  ...
  fr: {
    ...
    pages: {
      ...
      feedback: { what: "Une lecture guidée de votre semaine à partir de la routine, des habitudes et de votre question.", why: "Elle transforme les données en apprentissage pratique et en prochain ajustement.", how: "Décrivez clairement votre besoin après avoir enregistré quelques jours.", connections: "Elle utilise Routine et Habitudes et peut guider les Objectifs ou une discussion avec Alfred.", example: "Demandez : « Comment continuer à étudier sans abandonner le sport ? »" },
