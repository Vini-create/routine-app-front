...
export function MobileHeader({ title, infoPage }: { title: string; infoPage?: PageInfoKey }) {
  return (
    <header data-tour="app-header" className="sticky top-0 z-30 border-b border-[var(--border-soft)] bg-[var(--background-primary)]/78 px-5 py-3 pl-20 backdrop-blur-2xl lg:fixed lg:right-8 lg:top-6 lg:rounded-[1.25rem] lg:border lg:border-[var(--border-soft)] lg:bg-[var(--surface-ambient)] lg:p-2 lg:pl-2 lg:shadow-[var(--shadow-soft)]">
